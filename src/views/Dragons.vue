            ...
            >
              <div class="card-body p-0">
                <a class="mfp-image d-inline-block" title>
                  <img :src="dragon.flickr_images[2]" class="img-fluid" alt="work-image" />
                </a>
                <div class="content bg-white p-3">
                  <h5 class="mb-0">
                    <a href="page-work-detail.html" class="text-dark title">{{ dragon.name }}</a>
                  </h5>
                  <h6 class="text-muted tag mb-0 small">Type: {{ dragon.type }}</h6>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="col-md-6">
                <div class="media">
                  <div class="media-body">
                    ...
                    <p v-if="dragon.active != false" class="text-muted">Active</p>
                ...
                <div class="media">
                  <div class="media-body">
                    ...
                    <p class="text-muted">{{ dragon.dry_mass_kg }}kg/{{ dragon.dry_mass_lb}}lb</p>
                  </div>
                </div>
                <div class="media">
                  <div class="media-body">
                    ...
                    <p
                      class="text-muted"
                    >{{ dragon.diameter.feet }}feet/{{ dragon.diameter.meters}}meters</p>
                  </div>
                </div>
              </div>
            </div>
